...
import automationsPrismaRouter from './routes/automations-prisma';
...
import scraperIntegrationRouter from './routes/scraper-integration';
import webFormsRouter from './routes/web-forms';
...
app.use('/api/scraper', scraperIntegrationRouter);
